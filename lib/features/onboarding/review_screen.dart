...
class ReviewScreen extends StatelessWidget {
  ...
  Widget _buildRow(String label, String value, {bool isLast = false}) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        border: isLast 
            ? null 
            : Border(bottom: BorderSide(color: AppColors.line.withOpacity(0.5))),
      ),
      child: Row(
  ...
  Widget _buildInterests() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(bottom: BorderSide(color: AppColors.line.withOpacity(0.5))),
      ),
      child: Wrap(
        spacing: 8,
        runSpacing: 8,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: userData.photos.isNotEmpty
                                              ? DecorationImage(
                                                  image: FileImage(userData.photos.first!),
                                                  fit: BoxFit.cover,
                                                )
                                              : null,
                                        ),
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              userData.career.isNotEmpty ? userData.career : 'Ready to date',
                                              style: AppText.body.copyWith(
                                                color: AppColors.ink60,
                                                fontSize: 14,
                                                fontWeight: FontWeight.w500,
                                ...
                                Container(height: 1, color: AppColors.line.withOpacity(0.5)),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      _buildRow('Lifestyle', userData.lifestyle.isEmpty ? 'Not specified' : userData.lifestyle.join(' · ')),
                                      _buildRow('Education', userData.education),
                                      _buildRow('Photos', '${userData.photoCount} added'),
                                      _buildInterests(),
                                      _buildRow('Location', userData.location, isLast: true), 
                                    ],
                                  ),
                                ),
                              ],
        ...
        Padding(
          padding: const EdgeInsets.fromLTRB(AppDimens.pad, 8, AppDimens.pad, 24),
          child: PrimaryButton(
            'Create my profile',
            onTap: onFinish,
          ),
