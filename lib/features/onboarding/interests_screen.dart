...
class _InterestsScreenState extends State<InterestsScreen> {
          ...
          for (var category in data) {
            ...
            for (var option in options) {
              _allInterests.add(Interest(
                ...
                emoji: _getEmojiForCategoryKey(category['key']?.toString() ?? ''),
                category: catTitle,
              ));
            }
          }
  ...
  String _getCategoryEmoji(String category) {
    switch (category.toLowerCase()) {
      case 'creativity': return '🎨';
      case 'fan favorites': return '🎬';
      case 'food & drink': return '🍔';
      case 'travel & outdoors': return '✈️';
      case 'gaming': return '🎮';
      case 'wellness': return '🧘';
      default: return '✨';
    }
  ...
  Color _getCategoryColor(String category) {
    switch (category.toLowerCase()) {
      case 'creativity': return AppColors.pinkDeep;
      case 'fan favorites': return AppColors.gold;
      case 'food & drink': return AppColors.green;
      case 'travel & outdoors': return AppColors.blue;
      case 'gaming': return AppColors.ink60;
      case 'wellness': return AppColors.pink;
      default: return AppColors.pinkSoft;
    }
  }
  ...
  Widget _buildCategory(String categoryName, List<Interest> items) {
    ...
    int selectedCount = items.where((i) => _selectedInterests.contains(i)).length;
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isExpanded || selectedCount > 0 ? AppColors.pinkDeep : AppColors.line,
            width: 1.5,
          ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                      ...
                      children: [
                        Text(
                          ...
                          style: AppText.body.copyWith(
                            ...
                            color: isExpanded || selectedCount > 0 ? AppColors.pinkDeep : AppColors.ink,
                          ),
                        ),
                        const SizedBox(height: 2),
                        Text(
                          selectedCount > 0 ? '$selectedCount selected' : 'Select interests',
                  ...
                  Icon(
                    selectedCount > 0 ? Icons.check_circle : Icons.circle_outlined,
                    color: selectedCount > 0 ? AppColors.pinkDeep : AppColors.line,
                    size: 24,
                  ),
                ],
              ),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Pick at least 5 things you enjoy. It helps us find people who share your passions.',
                      style: AppText.body.copyWith(
