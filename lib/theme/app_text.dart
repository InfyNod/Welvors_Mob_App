...
class AppText {
  static TextStyle _base(double s, FontWeight w,
      {Color c = AppColors.ink, double ls = 0, double? lh}) =>
    GoogleFonts.dmSans(fontSize: s, fontWeight: w, color: c,
      letterSpacing: ls, height: lh);

  static final display = GoogleFonts.playfairDisplay(fontSize: 32, fontWeight: FontWeight.w700, color: AppColors.ink, letterSpacing: -0.5, height: 1.1);
  ...
  static final eyebrow = _base(11, FontWeight.w800, c: AppColors.muted, ls: 1.2);
}
