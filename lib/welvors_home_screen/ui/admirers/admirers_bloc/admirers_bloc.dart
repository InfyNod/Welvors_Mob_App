    ...
    return [
      {
        ...
        'quote': '"Loved your travel shelf — where was that Georgia photo taken?"',
      ...
      },
      {
        ...
        'statusTextColor': 0xFFE68A00,
        'statusBgColor': 0xFFFFF6E5,
        'quote': '"We matched on almost every interest. Had to say hi."',
        'progressState': 0,
        'actionText': 'Rose sent',
        'actionIconColor': 0xFFE43A6A,
        'actionBgColor': 0xFFF5F5F5,
        'actionTextColor': 0xFF757575,
      },
      {
        'id': 2,
        'name': 'Tanya',
