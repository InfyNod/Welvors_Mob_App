...
class AgePolicyScreen extends StatefulWidget {
  const AgePolicyScreen({super.key});

  @override
  State<AgePolicyScreen> createState() =>
      _AgePolicyScreenState();
}

class _AgePolicyScreenState extends State<AgePolicyScreen> {
  ...
  void initState() {
    super.initState();
    _legalDataFuture = _apiService.getLegalPage('AGE_POLICY_18_PLUS');
  }
