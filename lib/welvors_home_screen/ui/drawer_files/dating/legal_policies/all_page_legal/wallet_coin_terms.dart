...
class WalletCoinTermsScreen extends StatefulWidget {
  const WalletCoinTermsScreen({super.key});

  @override
  State<WalletCoinTermsScreen> createState() => _WalletCoinTermsScreenState();
}

class _WalletCoinTermsScreenState extends State<WalletCoinTermsScreen> {
  ...
  void initState() {
    super.initState();
    _legalDataFuture = _apiService.getLegalPage('WALLET_COINS_TERMS');
  }
