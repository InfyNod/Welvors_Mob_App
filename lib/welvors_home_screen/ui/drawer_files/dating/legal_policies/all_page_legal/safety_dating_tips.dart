...
class SafetyDatingTipsScreen extends StatefulWidget {
  const SafetyDatingTipsScreen({super.key});

  @override
  State<SafetyDatingTipsScreen> createState() => _SafetyDatingTipsScreenState();
}

class _SafetyDatingTipsScreenState extends State<SafetyDatingTipsScreen> {
  ...
  void initState() {
    super.initState();
    _legalDataFuture = _apiService.getLegalPage('DATING_SAFETY_TIPS');
  }
