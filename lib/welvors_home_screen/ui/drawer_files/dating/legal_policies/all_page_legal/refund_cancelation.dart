...
class RefundCancellationScreen extends StatefulWidget {
  const RefundCancellationScreen({super.key});

  @override
  State<RefundCancellationScreen> createState() =>
      _RefundCancellationScreenState();
}

class _RefundCancellationScreenState extends State<RefundCancellationScreen> {
  ...
  void initState() {
    super.initState();
    _legalDataFuture = _apiService.getLegalPage('REFUND_CANCELLATION_POLICY');
  }
