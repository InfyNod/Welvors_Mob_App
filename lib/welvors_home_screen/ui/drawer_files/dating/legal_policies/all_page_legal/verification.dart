...
class VerificationPolicyScreen extends StatefulWidget {
  const VerificationPolicyScreen({super.key});

  @override
  State<VerificationPolicyScreen> createState() =>
      _VerificationPolicyScreenState();
}

class _VerificationPolicyScreenState extends State<VerificationPolicyScreen> {
  ...
  void initState() {
    super.initState();
    _legalDataFuture = _apiService.getLegalPage('VERIFICATION_ID_POLICY');
  }
