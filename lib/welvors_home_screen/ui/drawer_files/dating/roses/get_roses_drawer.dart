...
class GetRosesDrawer extends StatefulWidget {
  ...
  static void show(BuildContext context, Map<String, dynamic> package, VoidCallback onPurchased) {
    showModalBottomSheet(
      ...
      builder: (context) => GetRosesDrawer(
  ...
  @override
  State<GetRosesDrawer> createState() => _GetRosesDrawerState();
}
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            '${int.parse(widget.selectedPackage['title'])} Roses',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color.fromRGBO(61, 169, 255, 1.0), // Brand Blue
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: isSelected ? const Color.fromRGBO(61, 169, 255, 1.0) : Colors.grey.shade200,
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: isSelected ? const Color.fromRGBO(61, 169, 255, 1.0) : Colors.white,
                border: Border.all(
                  color: isSelected ? const Color.fromRGBO(61, 169, 255, 1.0) : Colors.grey.shade300,
                  width: 1,
                ),
              ),
              child: isSelected
