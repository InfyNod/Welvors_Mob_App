...
import '../../../../../../onbording_allpage/services/api_service.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProfileEditCubit, ProfileEditState>(
      builder: (context, state) {
        String subtitle = '';
        if (!_isLoading && _intentions.isNotEmpty) {
          final option = _intentions.firstWhere(
            (element) => element['title'] == state.intention,
            orElse: () => {'subtitle': ''},
          );
                      ...
                      Expanded(
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            final option = _intentions[index];
