            ...
            const Row(
              children: [
                Icon(
                  ...
                  size: 16,
                ), // Using wine_bar as a lifestyle icon
                SizedBox(width: 8),
                Text(
                  "LIFESTYLE",
                  style: TextStyle(
              ...
              child: Column(
                ...
                children: [
                  _buildListItem(
                    ...
                    onSelect: (val) =>
                        context.read<ProfileEditCubit>().updateDrinking(val),
                  ),
                  _buildDivider(),
                  _buildListItem(
                    context: context,
                    ...
                    onSelect: (val) =>
                        context.read<ProfileEditCubit>().updateSmoking(val),
                  ),
                  _buildDivider(),
                  _buildListItem(
                    context: context,
                    ...
                    onSelect: (val) =>
                        context.read<ProfileEditCubit>().updateWorkout(val),
                  ),
                  _buildDivider(),
                  _buildListItem(
                    context: context,
                    ...
                    onSelect: (val) =>
                        context.read<ProfileEditCubit>().updateDiet(val),
                  ),
                  _buildDivider(),
                  _buildListItem(
                    context: context,
                    ...
                    onSelect: (val) =>
                        context.read<ProfileEditCubit>().updateTravel(val),
                  ),
                  _buildDivider(),
                  _buildListItem(
                    context: context,
                    ...
                    onSelect: (val) =>
                        context.read<ProfileEditCubit>().updateSleep(val),
                  ),
                  _buildDivider(),
              ...
              GestureDetector(
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    ...
                                    children: _petOptions.map((pet) {
                                      final isSelected = tempSelectedPets
                                          .contains(pet);
                                      return GestureDetector(
                                        onTap: () {
                                          if (!isSelected &&
                                              tempSelectedPets.length >= 3) {
                                            ScaffoldMessenger.of(
                                              context,
                                            ).showSnackBar(
                                              const SnackBar(
                                                content: Text(
                                                  'You can only select up to 3 pets.',
                                                ),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    ), // Dotted border is hard without package, solid for now
                  ),
                  child: const Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
