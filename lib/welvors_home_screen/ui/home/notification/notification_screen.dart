          ...
          return CustomScrollView(
            slivers: [
              SliverAppBar(
                ...
                title: Column(
                  ...
                  children: [
                    ...
                    if (state.status == NotificationStatus.loaded)
                      Builder(
                        builder: (context) {
                          final unreadCount = state.allNotifications.where((n) => n['isUnread'] == true).length;
                ...
                actions: [
                  if (state.status == NotificationStatus.loaded && state.allNotifications.any((n) => n['isUnread'] == true))
                    Center(
                      child: Padding(
              ...
              if (state.status == NotificationStatus.loading)
                ...
                SliverPadding(
                  padding: const EdgeInsets.only(left: 16.0, right: 16.0, top: 4.0, bottom: 48.0),
                  sliver: SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (context, index) {
                        ...
                        if (notif['isHeader'] == true) {
                          return Padding(
                            padding: EdgeInsets.only(top: index == 0 ? 8.0 : 20.0, bottom: 8.0, left: 4.0),
                            child: Text(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      text: TextSpan(
                                        ...
                                        children: [
                                          TextSpan(
                                            text: notif['title'],
                                            style: TextStyle(
                                              fontWeight: notif['title'].toString().contains(RegExp(r'[0-9]')) || notif['title'].toString().length < 20 
                                                  ? FontWeight.bold 
                                                  : FontWeight.normal,
                                            ),
                                          ),
                                          if (notif['action'] != null)
                                            TextSpan(
                                              text: notif['action'],
                                              style: TextStyle(
                                                fontWeight: notif['action'].toString().contains(RegExp(r'[0-9]')) || notif['action'].toString() == 'VIP'
                                                    ? FontWeight.bold 
                                                    : FontWeight.normal,
                                              ),
                                            ),
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: 13,
                                        color: isItalic ? Colors.grey.shade600 : Colors.grey.shade500,
